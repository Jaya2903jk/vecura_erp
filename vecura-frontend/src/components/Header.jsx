    ...
    return (
        <header className="topbar">
            ...
            >
                ...
                <option value="T Nagar">Chennai-T Nagar</option>
                <option value="Anna Nagar">Chennai-Anna Nagar</option>
                <option value="Porur">Chennai-Porur</option>
                <option value="Chromepet">Chennai-Chromepet</option>
                <option value="Coimbatore">Chennai-Coimbatore</option>
                <option value="Trichy">Chennai-Trichy</option>
                <option value="Madurai">Chennai-Madurai</option>
                <option value="Salem">Chennai-Salem</option>
                <option value="Vellore">Chennai-Vellore</option>
            </select>
            {/* ================= NOTIFICATION ================= */}
            <button
                className="icon-btn"
            ...
            <div style={{ width: "1px", height: "26px", background: "var(--border)", margin: "0 10px" }}></div>
